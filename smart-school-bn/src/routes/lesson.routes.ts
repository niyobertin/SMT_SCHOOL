...
import { lessonValidation } from "../schema/lessonSchema";
import { createLesson, deleteLesson, getLessons, getSingleLesson, updateLesson } from "../controller/lesson.controller";
 ...
 *               description:
 *                 type: string
 *                 example: "Description of lesson 1"
 *               order:
 *                 type: integer
 *                 example: 1
 *     responses:
...
/** 
 * @swagger
 * /api/lessons/get-lesson-by-id/{id}:
 *   get:
