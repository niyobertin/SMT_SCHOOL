...
export const UsersSection = () => {
  ...
  const handleStatusChange = async (id: string, active: boolean) => {
    setUpdatingRoleId(id); // Using the same state for role/status updates for simplicity
    try {
                ...
                <tr>
                  <td colSpan={5} className="px-4 py-12 text-center text-slate-500">
                    <div className="flex flex-col items-center justify-center">
                      <Loader2 className="w-8 h-8 animate-spin mb-2 text-[#1a7ea5]" />
                        ...
                        <td className="px-4 py-3 text-right">
                          <div className="flex items-center justify-end gap-1.5 transition-all">
                            <button
                              ...
                              className="p-1.5 text-slate-400 hover:text-[#1a7ea5] transition-all"
