...
import { BookOpen, Eye, EyeOff, Phone, Mail } from "lucide-react"
import { LanguageSwitcher } from "../components/common/LanguageSwitcher"
import { Link } from "react-router-dom";
import useLanguage from "../hooks/useLanguage";

// Country code data - you might want to move this to a separate file
const countryCodes = [
  { code: '+1', name: 'US' },
  { code: '+44', name: 'UK' },
  { code: '+33', name: 'FR' },
...
export const RegisterPage = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
      ...
      console.log("Registration attempt:", { ...formData, phone: formData.phone ? `${selectedCountryCode}${formData.phone}` : null });
    };
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
        ...
        <div className="w-full max-w-md bg-white shadow-lg rounded-2xl p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4 mt-6">
              ...
              <div className="flex items-center gap-2 mb-2">
                <button
                  ...
                  className={`px-3 py-1 rounded-lg text-sm font-medium ${
                    !showPhone ? 'bg-blue-100 text-blue-700' : 'text-gray-600 hover:bg-gray-100'
                  }`}
                >
            ...
            <button
              type="submit"
              disabled={!formData.agreeToTerms || (!formData.email && !formData.phone)}
              className="w-full py-2 rounded-lg text-white font-medium bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 disabled:opacity-50"
            >
              {t("createAccount")}
            </button>
